<?php
/*
* Template Name: Calculadora Hipoteca
...
get_header();
?>
<div class="printinfo" style="display: none;">lisbeth.herrera@gmail.com / (647) 833 1171</div>
			  ...
			  <div class="col-xs-12">
				...
				<div class="form-group">
				  ...
				  class="form-control input-md" required="">
					<span class="help-block">Este es el precio de la propiedad</span>
			  ...
			  <div class="col-xs-12">
				...
				<div class="form-group">
				  ...
				  <button id="calculate" name="calculate"  type="button" class="btn btn-primary btn-lg btn-block">
					  <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Calcular
					</button>
			...
			<div class="row">
			  <div class="col-xs-12">
				...
				<div class="form-group center">
				  ...
				  <span class="help-block">Este es el total a pagar por Transferencia de Tierra</span>
		...
		<div class="container-fluid" style="padding-top: 30px;padding-bottom: 20px;">
		  <form name="calculateThis" method="get">
			...
			<div class="row">
			  <div class="col-sm-3">
				<div class="form-group">
				  <label class="col-sm-12 control-label" for="io_price">Precio Listado</label>
				  <input name="io_price" type="text" value=""  id="io_price" class="form-control input-md">
				</div>
			  </div>
			  <div class="col-sm-3">
				<div class="form-group">
				  <label class="col-sm-12 control-label" for="io_interest">Tasa de Interés</label>
				  <input name="io_interest" type="text" value="5.25" id="io_interest" class="form-control input-md">
				</div>
			  </div>
			  <div class="col-sm-3">
				<div class="form-group">
				  <label class="col-sm-12 control-label" for="io_taxes">Taxes Anuales</label>
				  <input name="io_taxes" type="text" value="" id="io_taxes" class="form-control input-md">
				</div>
			  </div>
			  <div class="col-sm-3">
				<div class="form-group">
				  <label class="col-sm-12 control-label" for="io_condo">Cuotas del Condominio</label>
			...
			<div class="row">
			  <div class="col-sm-6">
				<div class="form-group">
				  <label class="col-sm-12 control-label" for="io_amortization">Amortización</label>
			...
			<div class="row">
			  <div class="col-sm-12">
				<p>* Estos cálculos son estimados, los resultados finales pueden variar.</p>
			  </div>
			</div>
		  </form>
		</div>
